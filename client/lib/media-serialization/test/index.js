...
describe( 'MediaSerialization', function() {
	...
	describe( '#deserialize()', function() {
		...
		it( 'should parse images with the data-istransient attribute as transient images', function() {
			const parsed = deserialize( '<img data-istransient="true" src="https://andrewmduthietest.files.wordpress.com/2015/01/img_0372.jpg" class="size-full wp-image-1627 alignright" alt="Example" width="660" height="660" />' ); // eslint-disable-line max-len
